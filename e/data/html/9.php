...
?><table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'><tr><td width='16%' height=25 bgcolor='ffffff'>滚动标题</td><td bgcolor='ffffff'><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#DBEAF5">
<tr> 
...
</table></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>滚动链接</td><td bgcolor='ffffff'>
<input name="link" type="text" id="link" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[link]))?>" size="120">
