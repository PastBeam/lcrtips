...
$ecms_config['db']['dbusername']='youku_ws';	//数据库用户名
$ecms_config['db']['dbpassword']='aWeYNneecJcTDAYr';	//数据库密码
$ecms_config['db']['dbname']='youku_ws';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='muban_la_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='ZVCxH16h8BP4md7EYdWPkHMffsCEP9l3txaS';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='ubuup';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='wwluk';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='yE2ALD1G10NVPn78FFHFtUpL5oI8mFj1vPx';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='FWMWLhOK7MEnbZB2Ihk0E5ZuVmS5MlGAF5';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='UwL3qk7nkQ3XQt9HdraSwze5iJp6DZ4yp';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='5etWxPd7LHdHQdMUQXQRcKiTUAddg8S3';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='Hix26DwioQTxiU3qGmJnwhMlG61auU4';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'gWSTvLmGlwgi5eQAT09GXQNBX9vxphWh',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/pingguo/\">苹果</a>&nbsp;|&nbsp;<a href=\"/anzhuo/\">安卓</a>&nbsp;|&nbsp;<a href=\"/yuedu/\">阅读赚钱</a>&nbsp;|&nbsp;<a href=\"/gonglue/\">试玩攻略</a>&nbsp;|&nbsp;<a href=\"/shouyegundongtupian/\">首页滚动图片</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'3ncsJkjDmclWewNqqZcBXTsrlTtCHuvsVMrn',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'e3HcmzvYeO1rY8mVo8pirySEAnXCK5LziszCyWkjvj',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'ctimeaddre'=>0,
'ctimeqaddre'=>0,
'deftempid'=>0,'add_muban_la_zfb'=>'573348282','add_muban_la_kf'=>'小表妹','add_muban_la_wx'=>'daqi-----');
//------------e_public
...
'intb'=>0,
'mid'=>8);
$etable_r['news1']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>9);
$etable_r['news2']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>10);
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,down,rew,sup,cash,type,video,intro,attention,',
'qenter'=>',title,special.field,titlepic,newstime,down,rew,sup,cash,type,video,intro,attention,',
'listtempf'=>',title,titlepic,newstime,down,rew,sup,cash,type,video,intro,attention,',
'tempf'=>',title,titlepic,newstime,down,rew,sup,cash,type,video,intro,attention,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,titlepic,newstime,down,rew,sup,cash,type,video,intro,attention,',
'canaddf'=>',title,titlepic,newstime,down,rew,sup,cash,type,video,intro,attention,',
'caneditf'=>',title,titlepic,newstime,down,rew,sup,cash,type,video,intro,attention,',
'tbmainf'=>',title,titlepic,newstime,type,attention,intro,down,video,rew,sup,cash,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',type,attention,intro,down,video,rew,sup,cash,',
'checkboxf'=>',sup,',
'savetxtf'=>'',
'editorf'=>',attention,intro,',
'ubbeditorf'=>',',
'pagef'=>'',
'smalltextf'=>',',
'filef'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,down,special.field,newstime,titlepic,',
'qenter'=>',title,ftitle,down,special.field,newstime,titlepic,',
'listtempf'=>',title,ftitle,down,newstime,titlepic,',
'tempf'=>',title,ftitle,down,newstime,titlepic,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>'',
'cj'=>',title,ftitle,down,newstime,titlepic,',
'canaddf'=>',title,ftitle,down,newstime,titlepic,',
'caneditf'=>',title,ftitle,down,newstime,titlepic,',
'tbmainf'=>',down,titlepic,newstime,ftitle,title,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',down,ftitle,',
'checkboxf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,link,special.field,newstime,titlepic,',
'qenter'=>',titlepic,',
'listtempf'=>',title,link,newstime,titlepic,',
'tempf'=>',title,link,newstime,titlepic,',
'mustqenterf'=>',title,link,titlepic,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>'',
'cj'=>',title,link,newstime,titlepic,',
'canaddf'=>',title,link,newstime,titlepic,',
'caneditf'=>',title,link,newstime,titlepic,',
