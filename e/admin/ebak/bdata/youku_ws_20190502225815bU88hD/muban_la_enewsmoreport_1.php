...
E_D("DROP TABLE IF EXISTS `muban_la_enewsmoreport`;");
E_C("CREATE TABLE `muban_la_enewsmoreport` (
...
E_D("replace into `muban_la_enewsmoreport` values('1',0xe4b8bbe8aebfe997aee7abaf,'','','','','0','0','0','0','','0','0');");
