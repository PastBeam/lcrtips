...
E_D("DROP TABLE IF EXISTS `muban_la_enewspostserver`;");
E_C("CREATE TABLE `muban_la_enewspostserver` (
...
E_D("replace into `muban_la_enewspostserver` values('1',0xe99984e4bbb6e69c8de58aa1e599a8,'','1','','','','','','0','0','0','0','0');");
