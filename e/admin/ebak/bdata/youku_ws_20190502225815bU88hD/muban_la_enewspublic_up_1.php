...
E_D("DROP TABLE IF EXISTS `muban_la_enewspublic_up`;");
E_C("CREATE TABLE `muban_la_enewspublic_up` (
...
E_D("replace into `muban_la_enewspublic_up` values('1','1355124469','1355124476','104','0',0x7c322c39317c31302c337c312c367c392c347c,'','1555211667','1555211667','1','11','0','0');");
